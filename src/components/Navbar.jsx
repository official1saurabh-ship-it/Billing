    ...
    return (
        <nav className={`fixed top-0 left-0 right-0 z-[1000] px-8 h-[70px] flex items-center justify-between transition-all duration-300 border-b ${
            ...
            <div className="flex items-center gap-3">
                <a href="#" className="hidden sm:inline-flex items-center border border-gray-300 rounded-lg px-4 py-2 text-sm font-medium text-[#1A0A00] hover:border-[#C8202D] hover:text-[#C8202D] transition-all no-underline">Log In</a>
