    ...
    return (
        <div className="flex flex-col min-h-screen">
            <main className="flex-grow pt-32 pb-20 px-4 md:px-8 bg-gradient-to-br from-[#FFF5E8] via-[#FFF0DC] to-[#FFF9F0] relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative z-10 bg-white/80 backdrop-blur-sm p-8 md:p-12 rounded-[30px] shadow-xl border border-white/50">
                    <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-8 border-b border-gray-100 pb-4">
                        {title}
                    </h1>
