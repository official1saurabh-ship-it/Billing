...
const HeroPage = () => {
    ...
    return (
        <div className="overflow-x-hidden font-['DM_Sans']">
            ...
            <section className="relative min-h-screen pt-28 md:pt-36 pb-16 md:pb-24 px-4 md:px-8 bg-hero-gradient flex items-center overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center w-full relative z-10">
                    ...
                    <div className="relative order-1 lg:order-2 mb-8 lg:mb-0">
                        <img src={final} alt="Screenshot of Biosoftech's Sales & Billing software interface on a dark background, showing an invoice and payment tracking." className="w-full" />
            ...
            {/* Solutions Section */}
            <section className="py-16 md:py-24 px-6 bg-white" id="solutions">
                <div className="max-w-6xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-12 md:gap-16">
                        <div>
                            ...
                            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-6 font-['Sora']">Streamline Your Invoicing</h2>
                            <p className="text-[#6B5040] text-base leading-[1.75] mb-8">
                                Generate professional invoices in seconds with automatic GST calculations. Send them via WhatsApp, email, or print — and get paid faster.
                            </p>
                            <div className="bg-[#FFF9F0] p-6 rounded-xl border border-[#E8D5B0]">
                                <h3 className="font-bold text-lg text-gray-800 mb-3 font-['Sora']">Real-Time Tracking</h3>
                                <p className="text-[#6B5040] text-sm leading-relaxed">
                                    Monitor invoice status, payment collections, and pending dues in real time. Know exactly who has paid and who hasn't — at a glance.
                                </p>
                            </div>
                        </div>
                        <div>
                            ...
                            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-6 font-['Sora']">Automate Your Sales Process</h2>
                            <p className="text-[#6B5040] text-base leading-[1.75] mb-8">
                                From lead to payment, automate every step of your sales cycle. Reduce manual work, eliminate errors, and close deals faster.
                            </p>
                            <div className="bg-[#FFF9F0] p-6 rounded-xl border border-[#E8D5B0]">
                                <h3 className="font-bold text-lg text-gray-800 mb-3 font-['Sora']">Secure Payment Gateway</h3>
                                <p className="text-[#6B5040] text-sm leading-relaxed">
                                    Accept payments securely via UPI, QR codes, and online gateways. Your transactions are encrypted and protected with bank-grade security.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        rounded-full px-4 py-1 text-xs font-semibold tracking-widest mb-6">
          ...
          shadow-md hover:shadow-lg transition flex items-center justify-center gap-2">
                        ...
                        {/* Secondary Button */}
                        <a href="/#contact" className="border border-white/70 px-8 py-4 rounded-lg font-semibold 
          hover:bg-white/10 transition flex items-center justify-center gap-2 no-underline" >
                            ▶ Book a Free Demo
                        </a>
